<template>
  <transition name="el-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="el-picker-panel el-date-range-picker el-popper ads-picker"
      :class="[
        {
  ...
  watch: {
    ...
    value(newVal) {
      if (!newVal) {
        ...
        this.rightDate = nextMonth(newVal);
      }
    },
  ...
  methods: {
    ...
    rightNextYear() {
      if (!this.unlinkPanels) {
        ...
        this.rightDate = nextMonth(this.leftDate);
        this.$emit("changeYearMonth", this.rightDate);
      } else {
