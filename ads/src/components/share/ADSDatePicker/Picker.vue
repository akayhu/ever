...
export default {
  ...
  computed: {
    ...
    selectionMode() {
      if (this.type === "week") {
        ...
        return "dates";
      } else if (this.type == "singlerange" || this.type == "dualrange") {
        return "range";
      }
      return "day";
    },
  ...
  methods: {
    ...
    mountPicker() {
      ...
      this.picker.allJobText = this.allJobText;
      ...
      this.picker.$on("pick", (date = "", visible = false) => {
        ...
        if (!visible) {
          this.$emit("confirmClick", date);
        }
      });

      this.picker.$on("closePanel", () => {
        this.handleClose();
      });
      ...
      this.picker.$on("changeYearMonth", val => {
