      ...
      <div v-if="specifiedSegment" class="pl-6 pr-6">
        ...
        <div class="applicant_block group_header mt-6 pb-6">
          <div class="data-row mb-4">
            <label>底價</label>
            <span class="name">{{ history.productPromoName }}</span>
            <label class="ml-2">促案</label>
          </div>
          <div class="data-row mb-4">
            <label>申請人</label>
          ...
          <div class="d-flex mb-4">
            <div class="data-row">
              <label>流程開始時間</label>
              <span>{{
                specifiedSegment.startDate ? specifiedSegment.startDate : "- -"
              }}</span>
            </div>
        ...
        >
          ...
          >
            <div class="data-row mb-4">
              ...
              <span
                >{{
                  record.approver?.empName || record.allowedApprover[0].empName
                }}
                {{
                  record.approver &&
...
const { productPromoHistory: history, loading } = toRefs(reviewStore);
...
const init = async () => {
  await reviewStore.getProductPromoHistory({ id: route.params.id });
