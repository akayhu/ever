...
var MediaPlayer = function (_Component) {
	...
	function MediaPlayer(props) {
		...
		_this.hyperImgError = function (e) {
			return _this._hyperImgError(e);
		};
		return _this;
	}
	...
	_createClass(MediaPlayer, [{
		...
		key: '_hyperImgError',
		value: function _hyperImgError(e) {
			this.setState({
				hyperImgError: true
			});
		}
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ styleName: 'linkBlock' },
							!this.state.hyperImgError && _react2.default.createElement('span', {
							...
							_react2.default.createElement('img', { styleName: 'loadImage', src: this.props.property.src, onError: this.hyperImgError })
						)
					)
				);
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('iframe', { width: '476', height: '267.5',
							src: 'https' + "://www.youtube.com/embed/" + this.props.property.file })
					)
				);
			} else {
...
exports.default = (0, _reactCssModules2.default)(MediaPlayer, _index2.default, { allowMultiple: true });