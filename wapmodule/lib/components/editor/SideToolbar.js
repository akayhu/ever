	...
	_createClass(SideToolbar, [{
		...
		value: function render() {
			...
			var _props = this.props,
			    ...
			    onTriggerUpload = _props.onTriggerUpload,
			    getFileInfo = _props.getFileInfo,
			    getSignatureDone = _props.getSignatureDone,
			    uploadToS3Done = _props.uploadToS3Done,
			    urlTransformDone = _props.urlTransformDone;
