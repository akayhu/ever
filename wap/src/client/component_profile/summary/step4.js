...
class Step4 extends React.Component {
	constructor( props ) {
		...
		this.state = {
			data: {
				innerEditor1: this.props.stepContentData.innerEditorContentStep4_1,
				innerEditor2: this.props.stepContentData.innerEditorContentStep4_2
			},
			errorMessage: {
				innerEditor1: '',
				innerEditor2: ''
	...
	submitUpdate() {
		if(this.state.data.innerEditor1 && this.state.data.innerEditor2){
			...
			const contentValue = `● 在團隊眼中我是一個${this.state.data.innerEditor1}，的人，因為我總是${this.state.data.innerEditor2}。\n`;
			this.props.editElfSave(3, contentValue);
			this.props.updateStepContent('innerEditorContentStep4_1', this.state.data.innerEditor1);
			this.props.updateStepContent('innerEditorContentStep4_2', this.state.data.innerEditor2);
			this.props.changeStepStatus('step5');
		} else {
			...
			<div>
				<div styleName="elf_completion_main">
					...
					<div styleName="elf_completion_bg">
						...
						<div styleName="elf_completion elf_completion_4_width elf_completion_4_right"></div>
					...
					<span className="sub_text" styleName="elf_percentage">4 / 8</span>
				</div>
				<div styleName="elf_main_content elf_main_content_4">
					<span className="h2">Step4 團隊眼中的我</span>
					<dl>
						<dd>‧ 在過去的經歷中，我的主管與同事常說我是一個
							<span styleName="elf_span_width">
								<TextField
									name="innerEditor1"
									value={ this.props.stepContentData.innerEditorContentStep4_1 }
						...
						<dd>‧ 他們會有這樣的印象，可能是因為我
							<span styleName="elf_span_width">
								<TextField
									name="innerEditor2"
									value={ this.props.stepContentData.innerEditorContentStep4_2 }
									onChange={ this.onChange.bind(this) }
									onBlur={ this.onBlur.bind(this) }
					...
					<div styleName="btn_content">
						...
						<span styleName="btn_content_span"><button className="ui normal button" onClick={ ()=>this.changeStepStatus( 'step3' ) }>回上一題</button></span>
...
export default CSSModules(Step4, css, { allowMultiple: true });
