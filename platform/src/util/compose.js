...
function compose (...funcs) {
  ...
  return (...args) => _.reduceRight(rest, (composed, f) => f(composed), last(...args));
}
...
function parseArgsToArray (args) {
  ...
  return _.map(args, arg => {
      ...
      throw new Error('you should pass arrays that contain function or functions as parameters');
    })
}
...
//  console.log(composed(2)) //output: 21
*/
